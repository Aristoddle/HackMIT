...
var sendDocumentServer = function(req, res) {
  ...
  storageRef.child('TestFile.pdf').getDownloadURL().then(function(url) {
      ...
      console.log('Failed to download due to ' + error.message);
    });
